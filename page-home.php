...
<section class="home-module-10">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="extra-padding">
                        <h2>We Service the Entire <span class="br-xs">El Paso Area</span></h2>
        ...
        <div class="container">
            <div class="flex-row row">
                ...
                <div class="flex-col col-md-5 col-md-offset-1">
                    <div class="extra-padding"><h2>The Importance <span class="br-xs">of Maintenance</span></h2>

                        <p>We stress the importance of maintaining and servicing your roof with regularity. To ensure there are no issues, we offer regular maintenance service and inspections. Our roofers will look for any trouble spots and if there are any, we will fix and stop the problem from becoming a bigger (and more expensive) issue.</p></div>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-md-5 col-md-offset-1">
                    <div class="extra-padding"><h2>Our Values and Our Promise</h2>
                        ...
                        <h3>We strive for quality, value, <span class="brn-xs">and honesty.</span></h3>
                        ...
                        <div class="roof-image hidden-md hidden-lg">
                            <img src="<?=IMGURL?>bg-roof-mobile.jpg" class="" alt="Roof" />
                        </div>
            ...
            <div class="row">
                <div class="col-md-6 text-center">
                    <div class="extra-padding"><img src="<?=IMGURL ?>satisfaction-guaranteed.png" alt="100% Satisfaction guaranteed" />
                        <h2>About Our Guarantee <span class="br-xs">& Discounts</span></h2>
